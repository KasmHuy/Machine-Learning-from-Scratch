...
- Đối với các hàm logarit (khi x tiến về 0 thì dần ra vô cực) và hàm mũ (x tiến ra vô cực thì dần về 0), nếu không kiểm soát rất dễ gặp hiện tượng trượt liên tục xuống dốc không có điểm dừng. Vì vậy nên tối ưu hóa bằng giới hạn số bước lặp. 
## Key learnings
- loss function
- gradient descent
- learning rate
